...
export const RAYDIUM_CONCENTRATED_LIQUIDITY = 'CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK'
...
export const SOLANA_ADDRESS : string = 'So11111111111111111111111111111111111111112'
export const USDC_ADDRESS : string = 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'
export const USDT_ADDRESS : string = 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB'
export const jitoValidators = [
...
export const jitoEndpoints : string[] = ["https://mainnet.block-engine.jito.wtf/api/v1/bundles"]
...
export const TOKEN_PROGRAM_ID1 = new PublicKey("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");
